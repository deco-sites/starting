...
function DndButton(props: DndButtonProps) {
    return (
        <button 
            ...
            data-dnd-button
            class="absolute z-20 opacity-0 rounded-3xl h-14 px-6 sm:h-24 sm:text-2xl sm:px-10 flex items-center justify-center gap-4 text-black"
        >
        ...
        <>
            <div class="box-border h-fit my-8 mx-6 sm:mx-8 lg:mx-20 lg:my-20">
                <div class="h-[720px] overflow-hidden w-full rounded-3xl bg-black relative">
                    <img src="/camp/ellipse.png" class="absolute bottom-0 right-0 rotate-180" />
                    <img src="/camp/ellipse.png" class="absolute top-0 left-0"/>
