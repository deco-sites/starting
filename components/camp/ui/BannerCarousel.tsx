import Button from "$store/components/camp/ui/Button.tsx";
import Icon from "$store/components/camp/ui/Icon.tsx";
import Slider from "$store/components/camp/ui/Slider.tsx";
import SliderJS from "$store/islands/SliderCampJS.tsx";
