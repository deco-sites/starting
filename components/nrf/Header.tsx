...
function MobileMenuLink({ href, label, targetBlank, nested }: MenuLink) {
  ...
  if (nested && nested.length > 0) {
    return (
      <li class="relative h-full grid" {...props}>
        <Dropdown items={nested} value={label} />
      </li>
    );
  }
...
export default function Header(props: Props) {
  return (
    <section class="lg:container rounded-lg bg-white/5 backdrop-blur-xl fixed top-2 lg:top-6 z-50 w-[calc(100vw-16px)] lg:w-full left-1/2 transform -translate-x-1/2 shadow-[0px_4px_16px_0px_rgba(0,0,0,0.10)]">
      <nav class="flex flex-row gap-16 items-center h-[63px] pb-[2px] max-w-screen-2xl m-auto relative">
        <a class="flex items-center h-full pl-4 lg:pl-8 pb-[6px]" href="/">
          <Image src={props.logo} alt={props.logo} width={200} />
        </a>
        ...
        <div class="ml-auto lg:hidden pr-4 lg:pr-8">
          <div class="grid items-center">
            ...
            <label
              for="menu-opener"
              class="focus:outline-none peer-checked:[&>svg:first-child]:hidden peer-checked:[&>svg:last-child]:block"
            >
              <svg
                width="35"
                height="32"
