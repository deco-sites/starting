    ...
    >
      ...
      <div class="relative">
        ...
        <div class="relative overflow-hidden">
          <div class="flex">
            <SliderFocus
              class="flex gap-4 carousel-start"
              itemClass="h-full"
              ...
              {cards.map((card, index) => (
                ...
                >
                  <article class="flex flex-col gap-6 overflow-hidden backdrop-filter backdrop-blur-22 transition-all duration-300">
                    ...
                    <div class="flex flex-col gap-4 justify-between rounded-[8px] h-[47%] group-hover:space-y-0">
                      <div class="flex flex-col gap-4 overflow-hidden">
                        <h5 class="w-[384px] flex gap-2 font-medium not-italic text-left text-[14.5px] leading-[115%] tracking-[-0.72px] lg:text-[24px] text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          {card.label}
                          <svg
                        ...
                        <div class="w-[384px] text-[9.66px] lg:text-[16px] text-[#9CA3AF] leading-[1.5] line-clamp-2 overflow-ellipsis text-left opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          {card.description}
                        </div>
                      </div>
                    </div>
        ...
        <div class="flex flex-row justify-end">
          <button
            class="rounded-full p-3 bg-[#02F67C] focus:outline-none flex items-center justify-center border-none border-0 absolute left-[0.5rem] sm:left-[6rem] top-[18%] z-40"
            data-slide="prev"
          ...
          <button
            class="rounded-full p-3 bg-[#02F67C] focus:outline-none flex items-center justify-center border-none border-0 absolute top-[18%] right-[0.5rem] sm:right-[6rem] z-40"
            data-slide="next"
