...
export default function Community(
  ...
  return (
    <section class="flex flex-col items-center justify-center pb-6 lg:flex-row-reverse lg:gap-[75px] bg-white md:py-[63px] px-6 md:px-[2rem] max-w-screen-2xl mx-auto overflow-x-hidden overflow-y-hidden 2xl:overflow-x-unset 2xl:overflow-y-unset">
