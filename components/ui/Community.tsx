...
const DEFAULT_TEXT =
  "<p class=''>Backed up by a community of<span style='color:#02F67C; background: var(--gradient-1, linear-gradient(93deg, #02F67C 44.7%, #3FB67B 118.6%)); background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;' class=''>1000+ members</span></p>";
      ...
      <section class="flex flex-col-reverse gap-20 lg:flex-row items-center justify-center lg:flex-row-reverse lg:gap-[75px] pt-28 pb-20 lg:py-28 lg:pt-40 px-6 md:px-16 max-w-screen-2xl mx-auto overflow-x-hidden overflow-y-hidden 2xl:overflow-x-unset 2xl:overflow-y-unset">
        <div class="flex flex-col gap-4 justify-center relative w-[90%] lg:w-[50%]">
          ...
          <Image
            ...
            src={peopleImage}
          />
          <span class="text-[#A1A1AA] font-normal lg:text-[1.25rem] leading-[150%]">
            Community members
          </span>
        </div>
