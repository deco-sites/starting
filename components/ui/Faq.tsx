          ...
          return (
            <details class="border-b border-solid border-[#131614]">
              <summary class="flex flex-row py-5 gap-[16px] group cursor-pointer">
                ...
                <p class="font-normal not-italic text-[22px] leading-[1.3] text-[#131614] md:text-[32px] md:leading-[38.73px]">
                  {item.question}
                </p>
              </summary>
              <p class="pl-[32px] pb-5 font-normal not-italic text-[16px] leading-[1.9] text-[#131614] md:text-[20px] md:leading-[30px]">
                {item.answer}
              </p>
            </details>
          );
