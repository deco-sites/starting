...
return (
    <section class="bg-[#0A2121] lg:h-[100vh] flex justify-center items-center flex-col">
            ...
            {cards?.map(card => (
                <>
                    <div class="border-box relative flex flex-col p-[1px] rounded-lg" style="background: linear-gradient(to bottom, rgba(255, 255, 255, 1), rgba(255, 255, 255, 0))">
                        <div class="bg-[#223737] rounded-lg h-full w-full gap-4 p-[32px]">
                            ...
                            <p class="font-sans not-italic	font-normal text-[22px] md:text-[16px] lg:text-[22px] leading-[30px] text-white">
                                {card.text}
                            </p>
                        </div>
                    </div>
