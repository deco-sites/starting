...
This article guides you through creating and configuring a website on [**deco.cx**](http://deco.cx) for an online store using data from the Nuvemshop e-commerce platform [Nuvemshop](https://www.nuvemshop.com.br/).
...
4. Change the account configuration from `https://lojadolucis.lojavirtualnuvem.com.br` to your Nuvemshop Store public URL.

5. After that, you will se a button to get your Store Id and Access Token. Click on this button to be redirected to install the deco.cx App on the Nuvemshop panel.
