...
3. If you prefer to republish a previously published version of a release other than the current published one, you can click on `…` and then click on `Publish` to restore your chosen version. <img width="1440" alt="image" src="https://user-images.githubusercontent.com/84691125/253418205-d482c02c-7344-401d-8862-521370148f69.png">