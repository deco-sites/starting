...
export default function Carousel(props: Props) {
  ...
  return (
    <div>
        <div id="desktopCarousel" class={"flex flex-row gap-[2%] px-6 md:px-[7rem] group transition-[translate] ease-in-out duration-700 "+ "md:-translate-x-["+(28*transition)+"%]"+ " -translate-x-["+(92*transition)+"%]"}>
