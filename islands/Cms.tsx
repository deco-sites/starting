...
export default function Cms(props: Props) {
  const [lineButton, setLineButton] = useState({
    leftColor: "animate-backgound-color",
    leftHeader: "animate-left-opacity",
    leftLine: "animate-left-time-line",
    leftText: "animate-left-text",
    leftImage: "animate-left-image",
    leftImageMobile: "animate-left-image-mobile",
    rightHeader: "animate-right-opacity",
    rightLine: "animate-right-time-line",
    rightText: "animate-right-text",
    rightImage: "animate-right-image",
    rightImageMobile: "animate-right-image-mobile",
  });
  return (
    <div>
      <div
        class={`md:px-[5rem] pt-6 md:pt-[4rem] bg-[#053535] md:rounded max-w-screen-2xl m-auto overflow-hidden ${lineButton.leftColor}`}
      >
        <div class="px-3 md:px-0 flex flex-row gap-[4%]">
          <div
            class="relative w-[48%] flex-shrink-0 cursor-pointer"
            onClick={() => {
          ...
          >
            <p
              class={`font-inter not-italic font-medium text-white text-[20px] leading-[24.2px] pb-4 md:text-[32px] md:leading-[38.73px] ${lineButton.leftHeader}`}
            >
              {props.leftHeader}
            </p>
            <div>
          ...
          >
            <p
              class={`font-inter not-italic font-medium text-white text-[20px] leading-[24.2px] pb-4 md:text-[32px] md:leading-[38.73px] ${lineButton.rightHeader}`}
            >
              {props.rightHeader}
            </p>
            <div>
        ...
        <div class="px-3 flex flex-row gap-3 py-6 overflow-hidden md:hidden">
          ...
          >
            ...
            <p
              class={`font-sans not-italic font-normal text-[#F3FFF9] text-[20px] leading-[30px] ${lineButton.leftImageMobile}`}
            >
              {props.leftContent}
            </p>
          </div>
          ...
          >
            ...
            <p
              class={`font-sans not-italic font-normal text-[#F3FFF9] text-[20px] leading-[30px] ${lineButton.rightImageMobile}`}
            >
              {props.rightContent}
            </p>
          </div>
        ...
        <div class="hidden md:px-0 md:flex md:flex-row md:gap-[4%] md:pt-12 md:overflow-hidden">
          ...
          >
            ...
            <p
              class={`font-sans not-italic font-normal text-[#F3FFF9] text-[20px] leading-[30px] md:${lineButton.leftText}`}
            >
              {props.leftContent}
            </p>
          </div>
          ...
          >
            ...
            <p
              class={`font-sans not-italic font-normal text-[#F3FFF9] text-[20px] leading-[30px] md:${lineButton.rightText}`}
            >
              {props.rightContent}
            </p>
          </div>
        ...
        <div class="pl-3 md:pl-0 flex flex-row gap-3 md:gap-[4%] pt-6 lg:h-[420px] xl:h-[510px] 2xl:h-[530px] transition ease-in-out group">
          <div class="flex flex-col w-[100%] md:w-[48%] gap-[2%] flex-shrink-0">
            <div
              class={`${lineButton.leftImageMobile} md:${lineButton.leftImage} z-0`}
            >
          ...
          <div class="flex flex-col w-[100%] md:w-[48%] gap-[2%] flex-shrink-0">
            <div
              class={`${lineButton.rightImageMobile} md:${lineButton.rightImage} z-0 border-t border-l`}
              style="border-image: linear-gradient(90deg, rgba(45,195,120,1) 20%, rgba(255,255,255,0) 60%) 1;"
            >
