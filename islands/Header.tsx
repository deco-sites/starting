          ...
          <ul class="md:flex md:flex-row md:gap-4">
            ...
            <div class={open ? "flex flex-col justify-between w-full gap-[40px] absolute bg-[#1F261F] left-0 top-[3rem] border-t z-50 px-6 md:hidden" : "hidden"} style="border-image: linear-gradient(90deg, rgba(45,195,120,1) 20%, rgba(255,255,255,0) 60%) 1;">
                ...
                {props.menuLinks.map((link) => {
                  return (
                    <li class="h-[50px] grid items-center">
                      <a href="" class="block px-3 font-inter font-normal text-[16px] leading-[19.36px] text-white-79">{link.label}</a>
                    </li>
                  )
                })}
              </ul>
              <ul class="flex flex-col">
                <li class="h-[50px] grid items-center">
                  <a href="" class="block px-3 font-inter font-normal text-[16px] leading-[19.36px] text-[#2FD180]">Portuguese</a>
                </li>
                <li class="h-[50px] grid items-center">
                  <a href="" class="block px-3 font-inter font-normal text-[16px] leading-[19.36px] text-[#2FD180]">English</a>
                </li>
                <li class="h-[50px] grid items-center">
                  <a href="" class="block px-3 font-inter font-normal text-[16px] leading-[19.36px] text-[#2FD180]">Login</a>
                </li>
              </ul>
              <ul class="flex flex-row justify-center">
                <li class="h-[50px] grid items-center">
                  <a href="" class="block px-3 font-inter font-normal text-[16px] leading-[19.36px] text-[#2FD180]">
              ...
              <div class="absolute right-0 hidden group-hover:block">
                ...
                <div class="flex flex-col w-[152px] bg-[#1F261F] p-4 gap-4 rounded">
                  <div class="flex flex-row items-center justify-between">
                    <a href="" class="block font-sans not-italic font-normal leading-[20px] text-[15px] text-[#2FD180]">Portuguese</a>
                  </div>
                  <div class="flex flex-row items-center justify-between">
                  <a href="" class="block font-sans not-italic font-normal leading-[20px] text-[15px] text-[#2FD180]">English</a>
            ...
            <li class="hidden md:block md:px-3 md:py-1 md:border-1 md:rounded-full md:border-[#1F261F] md:hover:border-[#2FD180] md:transition md:ease-in-out md:duration-300">
              <a href="#" class="block font-inter font-normal text-[16px] leading-[19.36px] text-[#2FD180]">
                {props.login}
              </a>
            </li>
          </ul>
