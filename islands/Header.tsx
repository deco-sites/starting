        ...
        <nav class="flex flex-row justify-between items-center h-12 max-w-screen-2xl m-auto">
          ...
          <ul class="hidden md:flex md:flex-row md:gap-4 px-3">
            <li class="group cursor-pointer md:relative">
              <a href="#" class="hidden md:flex gap-2 items-center md:px-3 md:py-1 md:border-1 md:rounded-full md:border-[#1F261F] md:hover:border-[#2FD180] md:focus-within md:transition md:ease-in-out md:duration-300">
              ...
              <div class="absolute right-0 mt-3 hidden group-hover:block group-focus-within:block">
