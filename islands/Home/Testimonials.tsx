  ...
  return (
    <div class="relative lg:mx-auto lg:max-w-[1440px] relative z-10 px-4 py-14 lg:py-40 lg:px-0 flex flex-col gap-20 justify-center items-center">
        ...
        </div>
        {
            ...
            >
                <button onClick={() => setShow(true)} class="mx-auto py-[8px] px-[12px] font-bold font-[argent-pixel] text-[16px] bg-[#02F67C] text-[#113032] border border-[#113032]">{showMoreLabel}</button>
            </div>
        }
    </div>
  );
