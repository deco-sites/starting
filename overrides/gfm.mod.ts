...
/**
 * I'm only doing this to allowfullscreen in iframe
 */
...
export function render(markdown: string, opts: RenderOptions = {}): string {
  ...
  return sanitizeHtml(html, {
    ...
    allowedAttributes: {
      ...
      h5: ["id"],
      h6: ["id"],
      iframe: ["src", "width", "height", "title", "allowfullscreen"], // Only used when iframe tags are allowed in the first place.
    },
    allowedClasses: {
