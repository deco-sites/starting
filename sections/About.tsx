  ...
  return (
    <section class="flex flex-col bg-[#F3FFF9]">
        <div class="px-6 pt-[3.68rem] md:px-[3.03rem] md:pt-[7.5rem]">
            <p class="font-sans font-bold not-italic text-[#202320] text-5xl md:text-9xl">Elevate your storefront<br/>to max <span class="text-[#2FD180]">performance</span><span class="hidden md:inline text-[#202320]"> |</span></p>
        </div>
        <div class="grid grid-cols-1 items-end gap-4 px-6 pt-[3.68rem] md:px-[3.03rem] md:py-[4rem] md:grid-cols-2">
            <p class="font-sans font-normal not-italic text-frame-515-rgba text-3xl">With deco you build fast, load faster,<br/>and optimize conversion rates - every day.</p>
            <div class="flex flex-row h-12 border-[1px] border-solid border-[#1F261F] md:w-3/4 md:justify-self-end">
                <input type="email" class="w-2/3 font-inter font-normal not-italic bg-input-rgba focus:outline-none placeholder-[#1F261F] pl-4" placeholder="Enter yout work email"/>
