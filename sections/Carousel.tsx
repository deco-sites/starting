            ...
            <div class="relative grid grid-cols-1 gap-8 px-6 md:grid-cols-3 md:px-[11rem]">
                <div class="flex flex-col rounded overflow-hidden">
                    <div class="relative h-60 bg-gray-600">
                        <p class="px-6 pt-4 font-inter font-normal not-italic text-base text-white" style="text-shadow: 0px 4px 7px rgba(0, 0, 0, 0.25);">BUSINESS</p>
                        <div class="absolute h-12 w-12 rounded-full bg-red-200 -bottom-6 left-6"></div>
                    </div>
                    <div class="grid h-32 bg-white rounded border-[1px] border-solid border-border-black-opacity">
                        <p class="px-6 font-inter font-normal not-italic text-xl text-black opacity-[80%] self-center justify-self-center">Boosting your store speed and optimizing sales</p>
                    </div>
                </div>
