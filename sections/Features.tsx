...
export default function Features({col1Text, col1Ttitle, col2Title, col2Text, col3Title, col3Text}: Props) {
  return (
    <section class="bg-[#053535]">
      <div class="grid grid-cols-1 gap-16 md:gap-32 md:grid-cols-3 px-6 pt-28 md:pt-20 pb-40 md:pb-24 md:px-[5rem] max-w-screen-2xl m-auto">
        <div class="flex flex-col gap-4">
          ...
          <p class="mt-2 md:mt-10 mr-32 md:mr-0 font-inter not-italic font-medium text-[32px] leading-[38.5px] text-white opacity-80">
            {col1Ttitle}
          </p>
        ...
        <div class="flex flex-col gap-4">
          ...
          <p class="mt-2 md:mt-10 mr-12 md:mr-0 font-inter not-italic font-medium text-[32px] leading-[38.5px] text-white opacity-80">
            {col3Title}
          </p>
          <p class="font-sans not-italic	font-normal text-[20px] leading-[30px] text-white opacity-80">
            {col3Text}
