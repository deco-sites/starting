            ...
            <div class="px-6 md:px-[3.03rem] flex flex-col md:flex-row md:justify-between gap-16">
                ...
                <div class="justify-center md:flex-grow">
                    <ul class="grid md:grid-cols-3 md:w-2/3 gap-4">
                        <li>
                            <a href="#" class="px-2 font-inter font-normal text-white opacity-[80%] block text-right md:text-left">Company</a>
                        </li>
                        <li>
                            <a href="#" class="px-2 font-inter font-normal text-white opacity-[80%] block text-right md:text-left">Community</a>
                        </li>
                        <li>
                            <a href="#" class="px-2 font-inter font-normal text-white opacity-[80%] block text-right md:text-left">Docs</a>
                        </li>
                        <li>
                            <a href="#" class="px-2 font-inter font-normal text-white opacity-[80%] block text-right md:text-left">Pricing</a>
                        </li>
                        <li>
                            <a href="#" class="px-2 font-inter font-normal text-white opacity-[80%] block text-right md:text-left">Camp</a>
                        </li>
                        <li>
                            <a href="#" class="px-2 font-inter font-normal text-white opacity-[80%] block text-right md:text-left">Blog</a>
                        </li>
                    </ul>
                </div>
                <ul class="hidden md:block md:flex md:flex-row">
                    <li>
                        <a href="#" class="px-2 font-inter font-normal text-white opacity-[80%]">Company</a>
                    </li>
                    <li>
                        <a href="#" class="px-2 font-inter font-normal text-white opacity-[80%]">Company</a>
                    </li>
