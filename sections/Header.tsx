    ...
    <nav class="flex flex-row justify-between items-center px-3 bg-[#1F261F]">
      ...
      <ul class="hidden md:flex md:flex-row md:gap-8">
        <li class="relative py-2 group">
          <a href="#" class="block px-2 font-inter font-normal bg-clip-text text-transparent bg-linear-white-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;">Company</a>
          <div class="absolute w-full h-[3px] bg-transparent bottom-0 bg-linear-transp-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;"></div>
        </li>
        <li class="relative py-2 group">
          <a href="#" class="block px-2 font-inter font-normal bg-clip-text text-transparent bg-linear-white-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;">Pricing</a>
          <div class="absolute w-full h-[3px] bg-transparent bottom-0 bg-linear-transp-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;"></div>
        </li>
        <li class="relative py-2 group">
          <a href="#" class="block px-2 font-inter font-normal bg-clip-text text-transparent bg-linear-white-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;">Community</a>
          <div class="absolute w-full h-[3px] bg-transparent bottom-0 bg-linear-transp-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;"></div>
        </li>
        <li class="relative py-2 group">
          <a href="#" class="block px-2 font-inter font-normal bg-clip-text text-transparent bg-linear-white-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;">Camp</a>
          <div class="absolute w-full h-[3px] bg-transparent bottom-0 bg-linear-transp-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;"></div>
        </li>
        <li class="relative py-2 group">
          <a href="#" class="block px-2 font-inter font-normal bg-clip-text text-transparent bg-linear-white-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;">Blog</a>
          <div class="absolute w-full h-[3px] bg-transparent bottom-0 bg-linear-transp-green bg-position-100 transition-[bg] ease-in duration-300 group-hover:bg-position-0" style="background-size: 200%;"></div>
        </li>
      </ul>
      <ul class="md:flex md:flex-row md:gap-4">
        ...
        <li class="hidden md:block md:px-3 md:py-1 md:border-1 md:rounded-full md:border-[#1F261F] md:hover:border-[#2FD180] md:transition md:ease-in-out md:duration-300">
          <a href="#">
            <div class="flex flex-row items-center gap-1">
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" stroke="#2FD180">
        ...
        <li class="hidden md:block md:px-3 md:py-1 md:border-1 md:rounded-full md:border-[#1F261F] md:hover:border-[#2FD180] md:transition md:ease-in-out md:duration-300">
          <a href="#" class="block font-inter font-normal text-[#2FD180]">Login</a>
        </li>
        <li class="hidden md:block md:px-3 md:py-1 md:border-1 md:rounded-full md:border-[#1F261F] md:hover:border-[#2FD180] md:transition md:ease-in-out md:duration-300">
          <a href="#" class="block font-inter font-normal text-[#2FD180]">Register</a>
        </li>
      </ul>
    </nav>
  );
