  ...
  return (
    <div>
        ...
        <div class={`lg:mx-auto z-20 lg:max-w-[1440px] relative z-20 px-4 py-14 lg:py-40 lg:px-0 flex flex-col gap-8 justify-center items-center`}>
            ...
            {
                subTitle &&
                <h3 class="font-albert-sans mx-11 inline-block text-[16px] lg:text-[20px] leading-7 text-center leading-[150%] text-[#949E9E] max-w-lg md:max-w-none" dangerouslySetInnerHTML={{
                    __html: subTitle
                }}></h3>
            }
