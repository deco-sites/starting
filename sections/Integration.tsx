  ...
  return (
    <section class="bg-[#053535]">
      <div class="flex flex-col px-3 gap-10 md:px-[7rem]  pt-4 pb-12 md:pb-32 max-w-screen-2xl m-auto">
        <p class='font-sans not-italic font-bold text-5xl text-white text-[56px] md:text-[128.94px] leading-[45px] md:leading-[105.5px] tracking[-1%]' dangerouslySetInnerHTML={{ __html: mainText }}></p>
