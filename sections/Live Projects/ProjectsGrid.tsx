...
function TemplatesGrid(props: Props) {
  ...
  return (
    <div className="flex flex-col items-center mx-8 pb-10 lg:mx-auto lg:py-20 lg:px-16 gap-y-11 lg:max-w-[1440px] bg-[#010101]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-11">
          {itensPaginaAtual.map(
            ({ label, description, link, image, category }, index) => {
              ...
              const shouldHideCategory = categoryInfo?.hideCategoryNameOnCard ||
                false;
